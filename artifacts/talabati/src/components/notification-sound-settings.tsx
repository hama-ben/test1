  ...
  return (
    <div className="glass-panel rounded-3xl p-6 border border-slate-100 dark:border-slate-800" dir="rtl">
          ...
          >
            ...
            {preset.id !== "silent" && (
              <button
                ...
                className="w-8 h-8 rounded-full bg-primary/10 dark:bg-primary/15 flex items-center justify-center text-primary hover:bg-primary/20 transition-colors shrink-0"
                title="معاينة"
              >
      ...
      <div className={`rounded-2xl border-2 border-dashed p-4 mb-5 transition-all ${
        customName ? "border-primary bg-primary/8 dark:bg-primary/10" : "border-slate-200 dark:border-slate-700"
      }`}>
        {customName ? (
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="w-8 h-8 rounded-full bg-primary/10 dark:bg-primary/15 flex items-center justify-center text-primary hover:bg-primary/20 transition-colors"
            >
              <Play className="w-3.5 h-3.5 fill-primary" />
            </button>
            <button
      ...
      <button
        type="button"
        onClick={handleSave}
        className="w-full py-3 rounded-2xl flex items-center justify-center gap-2 font-bold text-white bg-gradient-to-r from-primary to-cyan-500 shadow-md shadow-primary/25 hover:opacity-90 transition-all active:scale-[0.98]"
      >
        {saved ? (
